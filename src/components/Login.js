  ...
  return (
    <div>
      ...
      <form
        ...
        className="w-10/12 md:w-3/12 absolute p-6 md:p-12 bg-black my-36 mx-auto right-0 left-0 text-white rounded-md bg-opacity-85"
      >
        <h1 className="m-2 font-bold text-xl md:text-3xl py-4">
